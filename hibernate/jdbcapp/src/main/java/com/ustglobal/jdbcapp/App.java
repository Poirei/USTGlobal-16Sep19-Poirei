...
import com.ustglobal.jdbcapp.util.EmployeeManager;
...
public class App 
{
	public static void main( String[] args )
	{
		...
		switch (ch) {
		case 1:
			EmpInfoInf dao = EmployeeManager.getEmployeeDAO();
			List<EmpBean> result = dao.getAllEmployeeData();

			for (EmpBean bean : result) {
		...
		case 5:
			EmpInfoInf dao1 = EmployeeManager.getEmployeeDAO();
			System.out.println("Enter the Employee ID : \n");
			int id = sc.nextInt();
			EmpBean bean = dao1.searchEmployee(id);
		...
		case 2:
			EmpInfoInf dao2 = EmployeeManager.getEmployeeDAO();
		...
		case 3:
			EmpInfoInf dao3 = EmployeeManager.getEmployeeDAO();
			EmpBean bean11 = new EmpBean();
		...
		case 4:
			EmpInfoInf dao4 = EmployeeManager.getEmployeeDAO();
			EmpBean bean111 = new EmpBean();
